...
from et_document.doc.relationship_def import HisContent, SnapshotDocument, SnapshotPage, SnapshotParagraph
from et_document.doc.relationship_def import Document
from et_document.doc.relationship_def import Page
from et_document.doc.relationship_def import Paragraph
from et_document.doc.relationship_def import DocumentLabel
from et import settings
from et.enums import Status
from et.settings import DB, REDIS, CACHE_SETTING
...
def new_document(author, name, labels):
    ...
    if resp:
        REDIS.increment_page_total(type_=REDIS.Key.DocTabAll, user_id=CACHE_SETTING.get("Redis").get("NAME"))
