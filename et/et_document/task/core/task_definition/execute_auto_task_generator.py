...
class ExecuteAutoTaskGenerator(TaskGenerator):
    ...
    # @classmethod
    # def name(cls):
    #     return enums.Name.TaskType.ExecuteAutoTaskGenerator
    ...
    #     _spec["spec"] = enums.Name.TaskType.ExecuteAutoTaskGenerator
    #     return _spec
