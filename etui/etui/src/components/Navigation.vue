...
<!--          >-->
<!--            &lt;!&ndash; Download SVG icon from http://tabler-icons.io/i/moon &ndash;&gt;-->
<!--            <svg-->
<!--              xmlns="http://www.w3.org/2000/svg"-->
<!--              class="icon"-->
<!--              width="24"-->
...
<!--            data-bs-placement="bottom"-->
<!--          >-->
<!--            &lt;!&ndash; Download SVG icon from http://tabler-icons.io/i/sun &ndash;&gt;-->
<!--            <svg-->
<!--              xmlns="http://www.w3.org/2000/svg"-->
<!--              class="icon"-->
<!--              width="24"-->
...
<!--            ></span>-->
            <div class="d-none d-xl-block ps-2">
              ...
              <a class="btn btn-vk w-100 btn-icon">{{username}}</a>
